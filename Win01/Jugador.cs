...
namespace CuatroEnRaya_P002
{
    public class Jugador : INotifyPropertyChanged
    {
        ...
        public Jugador(String nom, String URI, SolidColorBrush color)
        {
            Nombre = nom;
            foto = null;
        ...
        /// <param name="color">color de la pieza</param>
        public Jugador(String nom, BitmapImage bmp, SolidColorBrush color)
        {
            Nombre = nom;
            foto = bmp;
        ...
        public Jugador(String nom, String URI)
        ...
        /// <param name="URI">Imagen del jugador</param>
        /// <param name="color">color de la pieza</param>
        public Jugador(String nom, SolidColorBrush color)
            : this(nom, "", color)
        {
        }
        ...
        public Jugador(SolidColorBrush col)
            : this("", "", col)
        {
        }
